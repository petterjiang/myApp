                ...
                <div className="contentSq">
                    ...
                    <div className="formSq">
                        <div className="inputList">
                            <span className="nameInput">国税网厅账户名</span>
                            <Input name="userName" className="userMsg" onChange={this.props.handleChange}/>
                        </div>
                        <div className="inputList">
                            <span className="nameInput">国税网厅密码</span>
                            <Input type="password" className="userMsg" name="password" onChange={this.props.handleChange}/>
                        </div>
                        <div className={this.props.yzmIsShow?"inputList show":"inputList hide"}>
                            ...
                            <Input className="userMsg yzm" placeholder="请输入验证码" name="yzm" onChange={this.props.handleChange}/>
                            {
                                this.props.yzmIsShow
                                    ?<a className="imgYzm" onClick={this.props.changeYzm} style={{fontSize:'14px'}}><img src={this.props.yzmUrl} /> <span>看不清？换一换</span></a>:""
                            }
                        </div>
                        <div className="sendBtn" style={{paddingLeft:'134px'}}>
